...
const home = {
    label: "Home",
    title: "Saim Qureshi's Portfolio",
    description: "Portfolio showcasing my work as a Full-Stack JavaScript Developer",
    headline: <>React & React Native Developer</>,
    subline: (
      <>
        I'm Saim, a full-stack JavaScript developer passionate about building modern web and
        mobile apps with <InlineCode>React</InlineCode>, <InlineCode>React Native</InlineCode>, 
        and <InlineCode>Node.js</InlineCode>. 
        <br /> Always exploring new ideas and creating projects that make an impact.
      </>
    ),
};
,
